 ...
 */
public class PasswordWizardStep implements WizardStep {
    ...
    public String title(Context context) {
        return context.getString(R.string.smoothsetup_enter_password);
    }
    ...
    /**
     * A Fragment that prompts the user for his password.
     */
