...
public abstract class DelegatingSingle<T> implements SingleSource<T>, Wrapable<Single<T>>
{
    private final SingleSource<T> mDelegate;


    public DelegatingSingle(SingleSource<T> mDelegate)
    {
