...
import com.smoothsync.smoothsetup.microfragments.CreateAccountMicroFragment;
 ...
 * @author Marten Gajda
 */
public final class CreateAccount implements MicroWizard<AccountDetails>
{
    private final MicroWizard<Account> mNext;


    public CreateAccount(MicroWizard<Account> next)
    {
        mNext = next;
    }
    ...
    {
        return new CreateAccountMicroFragment(accountDetails, mNext);
    }
