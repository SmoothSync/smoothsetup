...
import com.smoothsync.smoothsetup.microfragments.ValidateCustomMicroFragment;
 ...
 * @author Marten Gajda
 */
public final class ValidateCustomAccountLogin implements MicroWizard<AccountDetails>
{
    private final MicroWizard<AccountDetails> mNext;


    public ValidateCustomAccountLogin(MicroWizard<AccountDetails> next)
    {
        mNext = next;
    }
    ...
    {
        return new ValidateCustomMicroFragment(accountDetails, mNext);
    }
    ...
    private final static class WizardBox extends AbstractSingleBox<MicroWizard<AccountDetails>, MicroWizard<AccountDetails>>
    {
        ...
        {
            super(next, ValidateCustomAccountLogin::new);
        }
