...
/**
 * A {@link MicroFragment} to update the account (i.e. set a new password).
 *
 * @author Marten Gajda <marten@dmfs.org>
 */
public final class UpdateAccountMicroFragment implements MicroFragment<UpdateAccountMicroFragment.Params>
{
    public final static Creator<UpdateAccountMicroFragment> CREATOR = new Creator<UpdateAccountMicroFragment>()
    {
        @Override
        public UpdateAccountMicroFragment createFromParcel(Parcel source)
        {
            return new UpdateAccountMicroFragment(new Unboxed<AccountDetails>(source).value(), new Unboxed<MicroWizard<Account>>(source).value());
        }


        @Override
        public UpdateAccountMicroFragment[] newArray(int size)
        {
            return new UpdateAccountMicroFragment[size];
        }
    };
    ...
    public UpdateAccountMicroFragment(@NonNull AccountDetails accountDetails, MicroWizard<Account> next)
    {
